...
# --- DATABASE CONNECTION ---
MONGO_URL = "mongodb+srv://hackathon_user:ufg6kgf1d05aYHke@makg.iam7bee.mongodb.net/?appName=MAKG"
...
async def get_stats():
    ...
    async for doc in cursor:
        # This line converts the MongoDB ID to a string so it doesn't crash
        doc["_id"] = str(doc["_id"])
        results.append(doc)
    return results